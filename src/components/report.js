        ...
        <Page size="A4" style={styles.page}>
          <View style={styles.section}>
            <Text style={styles.title}>
              {data.company_name || "Global Company LLC"}
            </Text>
            <Text style={styles.subtitle}>
              Time frame of analysis: {data.time_frame || "2024-2029"}
            </Text>
          </View>
          <View style={styles.section}>
              ...
              <View style={styles.referenceTable}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <Text style={styles.tableCell}>
                    Global Company LLC Annual Report 2023
                  </Text>
                </View>
                <View style={styles.tableRow}>
                  ...
                  <Text style={styles.tableCell}>
                    Global Company LLC CSR report 2022
                  </Text>
                </View>
              </View>
            </View>
